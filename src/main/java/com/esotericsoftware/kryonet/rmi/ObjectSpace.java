 ...
 * The remote end of connections that have been {@link #addConnection(com.esotericsoftware.kryonet.Connection) added} are allowed to
 * {@link #getRemoteObject(com.esotericsoftware.kryonet.Connection, int, Class) access} registered objects.
 * <p>
 ...
 * value which is not {@link com.esotericsoftware.kryonet.rmi.RemoteObject#setNonBlocking(boolean) ignored}, an extra byte is written. If the type of a parameter is
...
public class ObjectSpace {
	...
	/** Creates an ObjectSpace with no connections. Connections must be {@link #addConnection(com.esotericsoftware.kryonet.Connection) added} to allow the remote
	...
	/** Creates an ObjectSpace with the specified connection. More connections can be {@link #addConnection(com.esotericsoftware.kryonet.Connection) added}. */
	 ...
	 * ObjectSpaces.
	 * @see #getRemoteObject(com.esotericsoftware.kryonet.Connection, int, Class...) */
	 ...
	 * request. This method is invoked on the update thread of the {@link com.esotericsoftware.kryonet.EndPoint} for this ObjectSpace and unless an
	...
	/** Identical to {@link #getRemoteObject(com.esotericsoftware.kryonet.Connection, int, Class...)} except returns the object cast to the specified interface
	 * type. The returned object still implements {@link com.esotericsoftware.kryonet.rmi.RemoteObject}. */
	 ...
	 * connection has not {@link #addConnection(com.esotericsoftware.kryonet.Connection) added} the connection to the ObjectSpace, the remote method invocations
	 * will be ignored.
	 * <p>
	 * Methods that return a value will throw {@link com.esotericsoftware.kryonet.rmi.TimeoutException} if the response is not received with the
	 * {@link com.esotericsoftware.kryonet.rmi.RemoteObject#setResponseTimeout(int) response timeout}.
	 * <p>
	 * If {@link com.esotericsoftware.kryonet.rmi.RemoteObject#setNonBlocking(boolean) non-blocking} is false (the default), then methods that return a value must
	 ...
	 * @see com.esotericsoftware.kryonet.rmi.RemoteObject */
